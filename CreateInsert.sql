...
create table Passport(
	Pass_Number varchar(25),
	Cus_ID int not null,
	S_date date not null,
	E_date date not null,
	Constraint PK_Passport Primary Key(Pass_Number),
...
create table Trip(
	...
	Constraint PK_Trip Primary Key(Pass_ID, Dep_day),
	Constraint FK_Trip_Visa Foreign Key(Country ,Visa_type) 
	References Visa(Country,Visa_type),
	Constraint FK_Trip_Cus Foreign Key(Pass_ID)
	References Passport(Pass_Number))
...
insert into Trip(Pass_ID, Dep_day, Country, Visa_type, Day_price, Day_count, Transport_price)
values 
('AR1112223','20200315','Germany', 'Medical',30,30,200),
('AK1122223','20221203', 'Italy','Tourist', 30, 5, 300), 
('AM1112323', '20230320', 'Germany', 'Student',20,30,200),
('AR1112223','20230115','USA','Tourist',30,20,1000),
('AM1112323','20221203', 'Italy','Tourist', 30, 5, 200),
('AK1122223', '20201115','USA', 'Tourist', 30,15,800),
('AR1552223','20190813', 'Greece','Tourist', 40, 10, 120),
('4577695122', '20230126', 'France', 'Tourist', 40,7,200),
('AM1112323', '20230126', 'France', 'Tourist', 40,7,150)
